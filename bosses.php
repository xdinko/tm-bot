...
$connection = new MongoDB\Driver\Manager( "mongodb+srv://root:$password1@cluster0-1tbeb.mongodb.net/test?retryWrites=true" ); // connect to a remote host (default port: 27017)
